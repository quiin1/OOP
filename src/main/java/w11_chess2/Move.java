...
public class Move {
    ...
    private final char[] row = {' ', 'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h'};

    /**
     * move piece(startX, startY) to (endX, endY) and not kill any piece.
     * @param startX .
     * @param endX .
     * @param startY .
     * @param endY .
    ...
    /**
     * move piece(startX, startY) to (endX, endY) and kill 1 piece.
     * @param startX .
     * @param endX .
     * @param startY .
     * @param endY .
